...
import numpy as np
import pandas as pd
from serendipity.deep.GRU4Rec import gru4rec
from serendipity.deep.GRU4Rec import evaluation

# PATH_TO_TRAIN = '/db_vol/hb_work/rnn/data/processed/recsys_challenge_train_full.txt'
PATH_TO_TRAIN = '/home/mokarakaya/Documents/phd/dataset/recsys2015-challenge-gru4rec/yoochoose-buys.dat'
# PATH_TO_TEST = '/db_vol/hb_work/rnn/data/processed/recsys_challenge_test.txt'
PATH_TO_TEST = '/home/mokarakaya/Documents/phd/dataset/recsys2015-challenge-gru4rec/yoochoose-test.dat'
